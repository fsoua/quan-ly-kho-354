...
class InventoryItem(models.Model):
    ...
    gia_nhap = models.PositiveIntegerField(default=0)
    gia_ban = models.PositiveIntegerField(default=0)
...
class Contract(models.Model):
    ...
    nq = models.CharField(max_length=50, blank=True, null=True)
    ngay = models.CharField(max_length=2, blank=True, null=True)
    thang = models.CharField(max_length=2, blank=True, null=True)
    nam = models.CharField(max_length=4, blank=True, null=True)
    dt_kho = models.CharField(max_length=15, blank=True, null=True)
    ...
    def __str__(self):
        return f"Hợp đồng {self.ten_nguoi_mat} - Lãi: {self.tong_tien_lai}"

class ContractDetail(models.Model):
    detail_id = models.AutoField(primary_key=True)
    contract = models.ForeignKey(Contract, on_delete=models.CASCADE, related_name='details')
    ...
    def __str__(self):
        return f"{self.inventory_item.item_name} (SL: {self.quantity})"    